...
contract Ballot {
    ...
    event ProposalCreated(address indexed _address, string _description);
    ...
    function createProposal(string _description) public {
      proposals.push(Proposal(msg.sender, _description, 0));
      ProposalCreated(msg.sender, _description);
    ...
    function getProposalDescription(uint index) view public returns(string) {
